...
local keyboard = {
{'قسم مطورين السورس'},
{'¤ قسم الألعاب ¤','¤ قسم التسليه ¤'},
{'¤ قسم المميزات ¤'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
end
if text == '¤ قسم الألعاب ¤' then
...
{'استوري','فديو اجنبي'},
{'▒━♧⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶𝑶𝑶 ℻ ⟧⟝♧━▒'},
{'لو خيروك بالصور','تويت بالصور','غنيلي فديو'},
{'▒━♧⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶𝑶𝑶 ℻ ⟧⟝♧━▒'},
{'قران','روايات'},
{'▒━♧⟞⟦ ℻ 𝑩𝑨𝑹𝑳𝑶𝑶𝑶 ℻ ⟧⟝♧━▒'},
{'ثيم','تصميم'},
...
local Text = 'قسم مسح واضف مثلا اضف رد عام حذف رد عام'
local Key = {
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [⚡╎ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙱𝙰𝚁𝙻𝙾](t.me/bar_lo0o0o0o0o)

 [⚡╎𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝙴𝙶𝚈𝙿𝚃](t.me/bar_lo0o0o0o0o)
 
  [⚡╎ 𝚁𝚄𝙽 𝚈𝙾𝚄𝚁 𝙱𝙾𝚃 𝚆𝙸𝚃𝙷 𝚄𝚂 𝙽𝙾𝚆](t.me/bar_lo0o0o0o0o)
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
 [◍ 𝐶𝐻 " 𝐵𝐴𝑅𝐿𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 ◍](t.me/bar_lo0o0o0o0o)
 ──┈┈┈┄┄╌╌╌╌┄┄┈┈┈

]] 
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◍ ⠇ٰ‌𝘿𝙀𝙑 𝘽𝘼𝙍𝙇𝙊 ⠇ٰ‌◍ ',url="t.me/bar_lo0o0"}},
{{text = '◍ ⠇ٰ‌𝘿𝙀𝙑 𝙂𝟴𝘼𝙕𝘼𝙇 ⠇ٰ‌◍ ',url="t.me/G8AZAAL"}},
{{text = '✈ • اضف البوت الي مجموعتك • ✈ ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if Text == '/hide' then
local hide = '🌝︙تم اخفاء كليشة الاوامر'
...
{
{text = '• أخفاء الكليشه •', callback_data="/hide"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
