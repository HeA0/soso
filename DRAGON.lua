...
sudo_users = {SUDO,1001132193,11111111111111,968613145,1477204348,1227722692,1885313077}   
...
var = true  
elseif tonumber(user_id) == tonumber(11111111111111) then
var = true  
elseif tonumber(user_id) == tonumber(1477204348) then
var = true  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᏟᎻ ᎠᎬᏙ!',url="t.me/Xccppp"}},
{{text = 'ᏟᎻ ᎬᏙᎪᏞ', url="t.me/SourceEval"},{text = 'ͲᎳՏΌᏞ', url="t.me/Quick0k"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./DRAGON.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceEval&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == 'باندا' or text == 'DRAGON' or text == 'DRAGON' then
local Text = [[
المبرمج باندا لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'عموره الجمد❤️',url="t.me/a2_c12"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/a2_c12&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'تيتو'  then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝓽𝓲𝓽𝓸
...
if tonumber(result.sender_user_id_) == tonumber(11111111111111) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1477204348) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(11111111111111) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if result.id_ == tonumber(1477204348) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(11111111111111) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1477204348) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━◍『ᎬᏙᎪᏞᏞ』◍━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━◍『ᎬᏙᎪᏞᏞ』◍━━━━⩺ٴ\n ◍ ◍ ')
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..☆💕](t.me/SourceEval)')
return false
end
end
end
